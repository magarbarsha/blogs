...
const Navbar = () => {
  ...
  <nav className="mx-auto flex max-w-6xl gap-8 px-6 transition-all duration-200 ease-in-out lg:px-12 py-4">
    ...
    <div className="hidden items-center justify-center gap-6 md:flex">
      <Link to="/Createpage" className="font-dm text-sm font-medium text-slate-700">Sign in</Link>
      <Link to="/Register" className="rounded-md bg-gradient-to-br from-green-600 to-emerald-400 px-3 py-1.5 font-dm text-sm font-medium text-white shadow-md shadow-green-400/50 transition-transform duration-200 ease-in-out hover:scale-[1.03]">Sign
        up for free
      </Link>
    </div>
